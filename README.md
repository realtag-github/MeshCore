...
- `wifi.webhook <url>` — set Discord webhook URL and save to prefs. Messages append hop info to the end of the content (e.g., `hello world [From: "Public Channel" Hops: AA>BB>CC]`).
